...
它使你能够**创建自己的自定义“赎回脚本”**，**但仍然可以轻松与其他人共享**。
...
## 在哪里可以找到P2SH脚本？
>寻找带有[3address](../../Keys/Address/Address.md#支付到脚本哈希p2sh)开头的输出。通过查看**脚本签名**中的**赎回脚本**的内容，可以确定它是什么类型的锁定（例如多重签名）。
