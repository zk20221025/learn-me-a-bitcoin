...
但在分层确定性钱包中，你可以使用单个**种子**创建**主私钥**，并使用它来生成数十亿个（4,294,967,296）“子”**私钥和公钥**。
...
因此，可以将**主公钥**发送到另一台计算机（例如，Web商店服务器）以生成新的接收地址，而不必担心如果服务器遭到入侵导致私钥被盗。
...
因此，通过使用**索引编号**将**主扩展私钥**哈希化，可以生成新**私钥**。
