...
![Mining-S-3.png](img/Mining-S-3.png)

接下来，我们为这个*候选块*构建一个块头。这基本上是块内所有数据的简要摘要，其中包括对我们要在其上构建的区块链中的现有块的引用。
![Mining-S-4.png](img/Mining-S-4.png)
...
![Mining-S-9.png](img/Mining-S-9.png)

然而，虽然任何人都可以尝试挖矿，但能够尽可能快地执行哈希计算确实可以提高成功挖掘新区块的机会。
![Mining-S-10.png](img/Mining-S-10.png)
...
![Mining-S-11.png](img/Mining-S-11.png)

如果你挖到了这个区块，一旦该区块在*最长的链*中达到100个块的深度，你就可以花费从coinbase交易中获得的比特币。
![Mining-S-12.png](img/Mining-S-12.png)

因此，这个**区块奖励作为一个激励**，促使矿工挖掘新的区块，并不断尝试扩展已知的最长区块链。
![Mining-S-13.png](img/Mining-S-13.png)
