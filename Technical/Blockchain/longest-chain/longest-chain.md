...
>工作量证明链是同步问题的解决方案，是在不必信任任何人的情况下即可了解全球共享视图的方法。-[中本聪](https://satoshi.nakamotoinstitute.org/emails/cryptography/7/)
...
因此，一个区块链中包含更多区块，其构建所需的能量也会更多，而节点总是会选择这个“最长”的链，而不是“更短”的链。
...
## 你如何计算最长的链？
最长的区块链是通过一个叫做“区块链上工作量总值”的度量来衡量的。
