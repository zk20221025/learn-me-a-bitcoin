...
![ECDSA-9.png](img/ECDSA-9.png)
P是用于曲线上一般点的字母。
s在此处指切线的斜率。
![ECDSA-10.png](img/ECDSA-10.png)
椭圆曲线点加倍。椭圆曲线操作。
...
![ECDSA-11.png](img/ECDSA-11.png)
Q只是用来表示曲线上第二个一般点的字母。
![ECDSA-12.png](img/ECDSA-12.png)
椭圆曲线点加法。
```ruby
def add(point1, point2)
  # double if both points are the same
...
* 公钥Q-**生成点G**乘以此随机数d。
![ECDSA-14.png](img/ECDSA-14.gif)
d是私钥（一个整数）
G是生成点（一个点）
Q是公钥（一个点）
![ECDSA-15.png](img/ECDSA-15.png)
...
![ECDSA-16.png](img/ecdsa-16.gif)
![ECDSA-17.png](img/ECDSA-17.png)
...
现在，我们可以将这些点相加以得到**点3**：
![ECDSA-19.png](img/ecdsa-19.gif)
![ECDSA-20.png](img/ECDSA-20.png)
