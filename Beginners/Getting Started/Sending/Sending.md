...
因此，**挖矿**过程基本上是一个**全网范围的竞争**，网络上的任何节点都有机会挖掘下一个区块。能够更快挖矿的节点更有机会挖掘下一个区块，但挖矿的过程是**不可预测的**，因此没有一个节点可以控制将区块添加到区块链中。
...
总的来说，**挖掘**是使多台计算机同意不断更新文件的方式，这对于依赖于跨计算机共享交易台账的数字货币至关重要。
...
因此，当内存池中有很多交易时，你对交易支付的费用越高，该交易被包括在块中的有效“优先级”就越高。

![Sending-11.gif](img/Sending-11%20(1).gif)

<center>一个好的钱包将允许你设置自己的费用，并给出交易被挖掘的预计时间。</center>
