...
您已经[拥有了一些比特币](../Buying/Buying.md)。现在您想将它们转移到另一个地址。
...
这适用于您使用的任何[比特币钱包](../getting-started/getting%20started.md)：
...
首先，您的交易被存储在每个节点的[memory pool](../../../Technical/Node/Memory%20Pool/Memory%20Pool.md)中，这类似于最近在网络上广播的交易的临时“等待区”。
...
为了将交易添加到区块链上，矿工将内存池中的交易收集到一个称为候选[块的容器](../../../Technical/Node/Candidate%20Block/Candidate%20Block.md)中。然后，节点使用能源来尝试将这个块“挖掘”到区块链的顶部。
...
一个好的钱包将允许您设置自己的费用，并给出交易被挖掘的预计时间。
...
* **1个确认**通常足够。
* **2个确认**，如果您想要额外的保险，以防自然的[链重组](../../../Technical/Blockchain/chain-reorganisation/chain-reorganisation.md)。
* **3个或以上的确认**，如果您担心网络规模的[攻击](../../../Technical/Blockchain/51-attack/51-attack.md)会逆转您的交易。
