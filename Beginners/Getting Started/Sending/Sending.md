...
因此，**挖矿**过程基本上是一个**全网范围的竞争**，网络上的任何节点都有机会挖掘下一个区块。挖掘速度更快的节点更有机会挖掘下一个区块，但挖矿的过程是**不可预测的**，因此没有任何一个节点可以控制将区块添加到区块链中。
...
比特币交易可以包含一笔比特币作为费用。这个费用将被**矿工收取，并作为激励**，让矿工将你的交易包括在他们的候选块中。
